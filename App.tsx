...
export default function App() {
  ...
  const handleAddData = async () => {
    try {
      ...
      Alert.alert('Error','Please enter value and try again')
     }
        ...
        <FlatList
          ...
          renderItem={item => {
            if (item.item !== null) {
              ...
              return (
                <TouchableOpacity style={styles.card} onPress={()=>handleCardPress(cardIndex,item.item.value)} onLongPress={()=>handleLongCardPress(cardIndex,item.item.value)}>
